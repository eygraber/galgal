...
The `nav` module contains the top level `GalgalNav` composable,
...
in the form of lambdas. This allows all navigation to happen centrally in `GalgalNav`, and doesn't leak
...
[DI DestinationComponent]: ./DI.md#galgal-di
