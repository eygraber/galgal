...
import com.eygraber.galgal.gradle.findToolchainIfNeeded
...
plugins {
  ...
  alias(libs.plugins.galgalGradle) apply false
}
...
gradleConventionsDefaults {
  ...
  projectCommon {
    ...
    projectDependencies {
      ...
      add("runtimeOnly", libs.galgalLint)
    }
  }
  ...
  issues {
    all {
      ...
      onAny {
        ...
        exclude("com.eygraber.galgal.lint:library")
