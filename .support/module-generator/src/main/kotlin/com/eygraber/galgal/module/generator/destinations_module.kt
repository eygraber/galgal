...
import com.eygraber.galgal.module.generator.utils.div
import java.io.File
...
internal fun createDestinationModule(
  ...
  val imports = listOf(
    *effectsImports,
    ...
    "com.eygraber.galgal.di.scopes.DestinationScope",
    "com.eygraber.galgal.di.scopes.NavScope",
  ).sorted()
    ...
    if(!exists()) {
        ...
        shouldGeneratePreview -> when {
          shouldGeneratePreviewParameterProvider ->
            arrayOf(
              ...
              "com.eygraber.galgal.ui.compose.PreviewGalgalScreen",
            )
      ...
      val themeImport = when {
        shouldGeneratePreview || shouldGeneratePreviewParameterProvider ->
          "com.eygraber.galgal.ui.material.theme.GalgalPreviewTheme"
  ...
  File(testPackageDir, "${featureName}ScreenshotTest.kt").apply {
    if(!exists()) {
      ...
      writeText(
        ...
        |
        |      GalgalEdgeToEdgePreviewTheme(isDarkMode = config.isDarkMode) {
        |        $viewName(
        |          state = $viewStateName,
        |          onIntent = {},
        |        )
