...
import com.eygraber.galgal.module.generator.utils.insertMultiline
import java.io.File
...
internal fun addToNavGraph(
  ...
  val navGraphFile = File(projectDir, "nav/src/main/kotlin/com/eygraber/galgal/nav/GalgalNav.kt")
  ...
  val factoryExtension =
    """
    |private val GalgalNavComponent.${featureCall}Factory
  ...
  navGraphFile.insertMultiline(
    ...
    intoAlphabetizedSectionWithPrefix = arrayOf("private val GalgalNavComponent."),
  )
