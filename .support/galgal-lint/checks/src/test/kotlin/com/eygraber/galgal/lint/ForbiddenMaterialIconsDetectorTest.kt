  ...
  fun singleForbiddenMaterialIcons() {
    runTest(
      code = """
          ...
          """,
      expectedOutput = """
        src/test.kt:5: Error: Usage of Icons from material-icons-core is not supported in Galgal. Use GalgalIcons instead. [ForbiddenMaterialIcons]
          Icons
          ~~~~~
        src/test.kt:6: Error: Usage of Icons from material-icons-core is not supported in Galgal. Use GalgalIcons instead. [ForbiddenMaterialIcons]
          Icons.Defaults
          ~~~~~
        src/test.kt:6: Error: Usage of Icons from material-icons-core is not supported in Galgal. Use GalgalIcons instead. [ForbiddenMaterialIcons]
          Icons.Defaults
                ~~~~~~~~
        src/test.kt:7: Error: Usage of Icons from material-icons-core is not supported in Galgal. Use GalgalIcons instead. [ForbiddenMaterialIcons]
          Defaults
          ~~~~~~~~
        4 errors, 0 warnings
        """,
  ...
  fun singleForbiddenMaterialIconsParameter() {
    runTest(
      code = """
          ...
          """,
      expectedOutput = """
        src/test.kt:4: Error: Usage of Icons from material-icons-core is not supported in Galgal. Use GalgalIcons instead. [ForbiddenMaterialIcons]
        fun test(icons: Icons) {}
                 ~~~~~~~~~~~~
        src/test.kt:5: Error: Usage of Icons from material-icons-core is not supported in Galgal. Use GalgalIcons instead. [ForbiddenMaterialIcons]
        fun test(icons: Icons.Defaults) {}
