...
import com.eygraber.galgal.app.di.android.AndroidActivityModule
...
interface GalgalActivityComponent : AndroidActivityModule, GalgalNavComponent.Factory {
  val splashScreenController: SplashScreenController

  @ContributesSubcomponent.Factory(AppScope::class)
  interface Factory {
    fun createGalgalActivityComponent(
      activity: Activity,
    ): GalgalActivityComponent
  }
}
