...
import com.eygraber.galgal.gradle.configureVersionCode
import com.eygraber.galgal.gradle.disableProdLocally
import com.eygraber.galgal.gradle.getInternalKeystorePassword
...
android {
  namespace = "com.eygraber.galgal.app"

  compileSdk = libs.versions.android.sdk.compile.get().toInt()

  defaultConfig {
    applicationId = "com.eygraber.galgal.galgal"
