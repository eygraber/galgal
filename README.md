...
## Replacing the galgal values

Run `./galgal_placeholders --project-name <PROJECT_NAME> --project-package <PROJECT_PACKAGE>` to replace
all the galgal values with your project's values.
...
After this you can delete `galgal_placeholders`.
